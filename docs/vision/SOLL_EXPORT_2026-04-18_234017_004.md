...
**Meta:** `{"rationale":"Avoid losing intent across iterations","updated_at":1776548416518}`

## Entités : Decision
### DEC-AXO-001 - Protect SOLL
**Status:** accepted
**Meta:** `{"context":"Agents previously removed conceptual state","rationale":"Exports must preserve the conceptual thread","updated_at":1776548416679}`
