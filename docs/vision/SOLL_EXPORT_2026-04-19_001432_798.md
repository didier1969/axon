...
**Status:** accepted
**Meta:** `{"context":"Agents previously removed conceptual state","rationale":"Exports must preserve the conceptual thread","scope":"restore","updated_at":1776550472444}`
...
**Meta:** `{"owner":"platform","updated_at":1776550471947}`

## Entités : Requirement
### REQ-AXO-001 - Reliable Restore
**Description:** Restore from official export without destructive reset
**Meta:** `{"priority":"P1","risk":"high","updated_at":1776550472172}`

## Entités : Validation
### VAL-AXO-001 - 
**Status:** passed
**Meta:** `{"evidence":"test","method":"vcr4-links","result":"passed","updated_at":1776550472755}`
