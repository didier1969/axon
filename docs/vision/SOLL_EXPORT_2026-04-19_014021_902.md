...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The system can generate a first coherent weekly plan and refine it through iterative user dialogue without losing week-level consistency.","updated_at":1776552459024}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The weekly plan explicitly combines home stock and planned shopping items in a single coordinated planning flow.","updated_at":1776552459032}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The default planning mode covers seven days and a simplified main-meals-only mode remains available.","updated_at":1776552459038}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The system can propose grouped preparation, leftovers, freezing, or batch-cooking patterns when they improve weekly execution.","updated_at":1776552459044}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"Food capture works with lightweight inputs such as scans, labels, images, or quick confirmations instead of requiring heavy manual entry.","updated_at":1776552464063}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"Real-life deviations can be absorbed through replanning without punitive logic and without collapsing the weekly plan.","updated_at":1776552464074}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The planning core scores candidate plans across nutrition, satiety, feasibility, cost, variety, waste reduction, and adherence probability.","updated_at":1776552464081}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"Important recommendations are explainable in clear user language with rationale, tradeoff, and practical impact.","updated_at":1776552464087}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The planning system remains actionable in a Swiss context with realistic local products, shopping behavior, and food assumptions.","updated_at":1776552469117}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The product architecture supports multi-tenant operation, strong protection of sensitive user data, and privacy-conscious design.","updated_at":1776552469129}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"The application core is organized around stable domain interfaces and replaceable adapters for LLMs, capture, optimization, and external data.","updated_at":1776552469135}`
...
**Status:** accepted
**Meta:** `{"acceptance_criteria":"Accepted material product and architecture decisions are recorded in SOLL as the canonical project memory.","updated_at":1776552469146}`
