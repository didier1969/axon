...
graph TD;
  ...
  GUI-AXO-005 -- INHERITS_FROM --> GUI-PRO-001;
  GUI-AXO-006 -- INHERITS_FROM --> GUI-PRO-001;
  GUI-AXO-007 -- INHERITS_FROM --> GUI-PRO-001;
  GUI-AXO-008 -- INHERITS_FROM --> GUI-PRO-001;
  GUI-AXO-009 -- INHERITS_FROM --> GUI-PRO-001;
  PIL-AXO-001 -- EPITOMIZES --> VIS-AXO-001;
  GUI-AXO-010 -- INHERITS_FROM --> GUI-PRO-001;
```

## Entités : Concept
### CPT-PRO-001 - MCP Validate Concept
**Description:** Synthetic MCP validation concept
**Meta:** `{"rationale":"Validation-only concept outside AXO scope","updated_at":1776539133034}`

### CPT-PRO-002 - MCP Validate Concept
**Description:** Synthetic MCP validation concept
**Meta:** `{"rationale":"Validation-only concept outside AXO scope","updated_at":1776539625685}`

### CPT-PRO-003 - MCP Validate Concept
**Description:** Synthetic MCP validation concept
**Meta:** `{"rationale":"Validation-only concept outside AXO scope","updated_at":1776544235746}`

### CPT-PRO-004 - MCP Validate Concept
**Description:** Synthetic MCP validation concept
**Meta:** `{"rationale":"Validation-only concept outside AXO scope","updated_at":1776550472970}`

### CPT-PRO-005 - MCP Validate Concept
**Description:** Synthetic MCP validation concept
**Meta:** `{"rationale":"Validation-only concept outside AXO scope","updated_at":1776551658336}`

## Entités : Decision
### DEC-AXO-001 - CDD Decision Attach
**Description:** Need hint
**Status:** accepted
**Meta:** `{"context":"ctx","rationale":"why","updated_at":1776551655218}`
...
### GUI-AXO-005 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`

### GUI-AXO-006 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`

### GUI-AXO-007 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`

### GUI-AXO-008 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`

### GUI-AXO-009 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`

### GUI-AXO-010 - TDD Obligatoire
**Description:** Les tests doivent être écrits avant ou avec le code source.
**Status:** active
**Meta:** `{"phase": "pre-code", "trigger_path": "src/axon-core/src/*", "required_path": "tests.rs", "enforcement": "strict"}`
...
## Entités : Pillar
### PIL-AXO-001 - CDD Attach Pillar
**Description:** Pillar for attach probe
**Meta:** `{"updated_at":1776551645732}`

## Entités : Vision
### VIS-AXO-001 - CDD Attach Vision
**Description:** Vision for attach probe
**Meta:** `{"updated_at":1776551645685}`
