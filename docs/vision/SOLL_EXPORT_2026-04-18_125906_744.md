...
graph TD;
  ...
  DEC-AXO-026 -- IMPACTS --> /home/dstadel/projects/axon/src/axon-core/src/mcp/tools_soll.rs;
  DEC-AXO-022 -- IMPACTS --> /home/dstadel/projects/axon/src/axon-core/src/graph_analytics.rs;
```
...
### DEC-AXO-027 - Live missing scope
**Status:** accepted
**Meta:** `{"context":"safe live qualification","rationale":"must fail without project_code","updated_at":1776472492841}`
...
**Description:** Le démon Axon ne doit plus s'exécuter de manière isolée dans le dossier de travail. Il doit devenir un service système unique écoutant sur un port global dédié (44129) avec une base de données unifiée. Les requêtes MCP exigeront le passage en paramètre du project_code ou le déduiront de l'URI.
**Status:** pending
**Meta:** `{"priority":"P1","updated_at":1776469108149}`
