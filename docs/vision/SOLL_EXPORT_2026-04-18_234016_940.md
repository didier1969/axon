...
**Status:** accepted
**Meta:** `{"context":"Agents previously removed conceptual state","rationale":"Exports must preserve the conceptual thread","scope":"restore","updated_at":1776548416768}`
...
**Meta:** `{"owner":"platform","updated_at":1776548416439}`

## Entités : Requirement
### REQ-AXO-001 - Reliable Restore
**Description:** Restore from official export without destructive reset
**Meta:** `{"priority":"P1","risk":"high","updated_at":1776548416597}`

## Entités : Validation
### VAL-AXO-001 - 
**Status:** passed
**Meta:** `{"evidence":"test","method":"vcr4-links","result":"passed","updated_at":1776548416917}`
