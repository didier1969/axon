...
## Entités : Concept
### CPT-AXO-001 - Merge Restore
**Description:** Reconstruct conceptual entities from export
**Meta:** `{"rationale":"Avoid losing intent across iterations","updated_at":1776552153449}`

## Entités : Decision
### DEC-AXO-001 - Protect SOLL
**Status:** accepted
**Meta:** `{"context":"Agents previously removed conceptual state","rationale":"Exports must preserve the conceptual thread","updated_at":1776552153722}`
...
## Entités : Milestone
### MIL-AXO-001 - Usable Internal Continuity
**Status:** in_progress
**Meta:** `{"updated_at":1776552153947}`

## Entités : Pillar
### PIL-AXO-001 - Concept Preservation
**Description:** SOLL must survive runtime churn
**Meta:** `{"updated_at":1776552152860}`

## Entités : Requirement
### REQ-AXO-001 - Reliable Restore
**Description:** Restore from official export without destructive reset
**Meta:** `{"priority":"P1","updated_at":1776552153125}`

## Entités : Validation
### VAL-AXO-001 - 
**Status:** passed
**Meta:** `{"method":"vcr4-e2e","result":"passed","updated_at":1776552154141}`

## Entités : Vision
### VIS-AXO-900 - Axon Vision
**Description:** Stable conceptual continuity
**Meta:** `{"goal":"Protect SOLL while evolving IST"}`
