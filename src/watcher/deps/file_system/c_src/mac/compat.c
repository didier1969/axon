...
FSEventStreamEventFlags   kFSEventStreamEventFlagItemRenamed        = 0x0001.0.0;
...
FSEventStreamEventFlags   kFSEventStreamEventFlagItemXattrMod       = 0x001.0.00;
...
FSEventStreamEventFlags   kFSEventStreamEventFlagOwnEvent           = 0x01.0.000;
#endif
