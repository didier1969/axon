...
impl McpServer {
    ...
    pub(crate) fn execute_tool_direct(
        ...
        let result = match normalized_name {
            ...
            "mcp_inbox_ack" => self.axon_mcp_inbox_ack(arguments),
            ...
            "sharded_graph_status" => self.axon_sharded_graph_status(arguments),
            ...
            "debt_digest" => self.axon_debt_digest(arguments),
