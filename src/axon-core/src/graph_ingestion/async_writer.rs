...
mod tests {
    ...
    // removed: SQL text renderers retired in favour of COPY BINARY
    // (flush_batch). See git history for the full parity gate suite.
    // DuckDB-era render_bulk_queries_with tests also removed.
    ...
    // DuckDB-era render_bulk_queries / render_bulk_queries_with tests
    // removed: SQL text renderers retired. See git history.
